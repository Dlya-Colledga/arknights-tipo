...
const merlin = `
<p class="dossier-intro">
  <strong>"Я — гибридный разработчик, способный соединить логику бэкенда с элегантностью фронтенда."</strong>
</p>

<h4 class="dossier-subtitle"><span>🚀</span> Путь Разработчика</h4>
<p>Мой путь в IT начался в 15 лет с осознанного выбора в пользу <strong>Frontend-разработки</strong>. Я успешно завершил профильные курсы, получив сертифицированное подтверждение своих навыков, и сейчас продолжаю оттачивать мастерство, обучаясь на втором курсе колледжа.</p>

<h4 class="dossier-subtitle"><span>💼</span> Коммерческий Опыт</h4>
<p>Я получил боевой опыт в компании <strong>"Алабуга"</strong>, где столкнулся с реальными enterprise-задачами. В мои обязанности входила разработка и поддержка систем на <strong>1C</strong>, а также бэкенд-разработка на <strong>Python</strong>.</p>
<p>Этот опыт научил меня работать в команде, понимать бизнес-процессы и находить эффективные решения в условиях жестких дедлайнов.</p>

<h4 class="dossier-subtitle"><span>⚙️</span> Основной Стек</h4>
<p>На данный момент я активно занимаюсь разработкой сайтов, фокусируясь на современном стеке:</p>
<ul class="dossier-skills">
  <li><strong>JavaScript (ES6+)</strong>: Уверенный уровень (Middle)</li>
  <li><strong>React.js</strong>: Глубокое понимание (Middle)</li>
  <li><strong>Python</strong>: Начальный, но уверенный уровень (Junior)</li>
  <li>Разработка и поддержка систем на <strong>1C</strong></li>
  <li>Frontend-архитектура и создание сайтов</li>
</ul>
`;
